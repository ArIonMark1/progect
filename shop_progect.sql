...
-- -----------------------------------------------------
-- Schema shop_progect_gb
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema shop_progect_gb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `shop_progect_gb` DEFAULT CHARACTER SET latin1 ;
USE `shop_progect_gb` ;
...
CREATE TABLE IF NOT EXISTS `shop_progect_gb`.`auto_park` (
  ...
  PRIMARY KEY (`id`),
  INDEX `auto_park_id_responsible-workers_id` (`id_responsible` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `shop_progect_gb`.`purchase_products` (
  ...
  PRIMARY KEY (`id`),
  INDEX `purchase_products_id_product-product_id` (`id_product` ASC) VISIBLE,
  INDEX `purchase_products_shop_id-shop_id` (`shop_id` ASC) VISIBLE,
  INDEX `purchase_products_responsabile_worker_id-workers_id` (`responsabile_worker_id` ASC) VISIBLE,
  INDEX `purchase_products_provider_id-provider_id` (`provider_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `shop_progect_gb`.`sale` (
  ...
  PRIMARY KEY (`id`),
  INDEX `sale_id_buyer-buyer_id` (`id_buyer` ASC) VISIBLE,
  INDEX `sale_id_product-product_id` (`id_product` ASC) VISIBLE,
  INDEX `sale_id_action-action_id` (`id_action` ASC) VISIBLE,
  INDEX `sale_id_workers-workers_id` (`id_workers` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `shop_progect_gb`.`relation_action_product` (
  ...
  INDEX `fk_term_action_has_product_product1_idx` (`product_id` ASC) VISIBLE,
  INDEX `fk_term_action_has_product_term_action1_idx` (`term_action_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `shop_progect_gb`.`relation_workers_staff` (
  ...
  INDEX `fk_workers_has_shop_staff_shop_staff1_idx` (`shop_staff_id` ASC) VISIBLE,
  INDEX `fk_workers_has_shop_staff_workers1_idx` (`workers_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `shop_progect_gb`.`relation_product_manufacturer` (
  ...
  INDEX `fk_product_has_manufacturer_manufacturer1_idx` (`manufacturer_id` ASC) VISIBLE,
  INDEX `fk_product_has_manufacturer_product1_idx` (`product_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `shop_progect_gb`.`relation_tupe_prod_product` (
  ...
  INDEX `fk_tupe_prod_has_product_product1_idx` (`product_id` ASC) VISIBLE,
  INDEX `fk_tupe_prod_has_product_tupe_prod1_idx` (`tupe_prod_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `shop_progect_gb`.`relation_shop_auto` (
  ...
  INDEX `fk_auto_park_has_shop_shop1_idx` (`shop_id` ASC) VISIBLE,
  INDEX `fk_auto_park_has_shop_auto_park1_idx` (`auto_park_id` ASC) VISIBLE,
